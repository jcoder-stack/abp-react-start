  ...
  return (
    <ComboboxPrimitive.Portal>
      <ComboboxPrimitive.Positioner
        ...
        anchor={anchor}
        // pointer-events-auto 必须显式给：Radix modal Dialog（Sheet/Dialog）开启时把 body 设为
        // pointer-events:none，base-ui 的 Portal 挂在 body 下、Radix 内容区之外，会整层继承 none——
        // 弹层看得见但鼠标点不中（键盘不受影响）。实测 elementFromPoint 落在 Sheet 内容上。
